...
void initRendering() {
    ...
    Image* image = loadBMP("bg.bmp"); // Memuat file gambar 
...
void drawScene() {
    ...
    GLfloat lightPos[] = {-2 * BOX_SIZE, BOX_SIZE, BOX_SIZE, 1.0f};
...
void update(int value) {
    ...
    glutPostRedisplay();
    glutTimerFunc(25, update, 0); // Panggil setiap 25ms 
}
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Texture With Image - Shalom"); // 
